...
function CreateNewApp({ onCreateApp }: { onCreateApp: (appName: string) => Promise<void> }) {
    ...
    return (
        <div className="min-h-[80px]">
            <h3 className="text-base font-medium mb-1 text-muted-foreground">Create New App</h3>
...
export function AppSelectionModal() {
    ...
    const handleSelectApp = async (appId: string) => {
        ...
        document.title = `App Builder (${appIdToUse})`;
    ...
    const handleCreateNew = async (appName: string) => {
        ...
        document.title = `App Builder (${draftAppId})`;
    ...
    return (
        <FlexiModal className="min-w-[600px] w-[600px] max-h-[90vh] overflow-y-auto">
            <div className="w-full px-2 pt-0 pb-4">
                <h2 className="text-2xl mb-2">Select an App to Edit</h2>
                ...
                {apps.length > 0 && (
                    <div className="mb-2">
                        <h3 className="text-base font-medium mb-1 text-muted-foreground">Existing apps</h3>
                ...
                <CreateNewApp onCreateApp={handleCreateNew} />
            </div>
        </FlexiModal>
    );
}
