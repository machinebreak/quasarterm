...
const previewElectronApi: ElectronApi = {
    ...
    openTextFile: (_opts?: { title?: string; extensions?: string[] }) => Promise.resolve(null),
    openDirectoryDialog: (_opts?: { title?: string }) => Promise.resolve(null),
    importBackgroundImage: (_opts?: { title?: string }) => Promise.resolve(null),
    setIsActive: async () => {},
};
